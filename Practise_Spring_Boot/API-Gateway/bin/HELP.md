...
* The original package name 'com.bankAccount.microservices.ZUUL.API.API Gateway' is invalid and this project uses 'com.bankAccount.microservices.ZUUL.API.API.Gateway' instead.
